...
import { NAV_ITEMS, PlaceholderPigeonIcon } from '../constants';
        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            <a href="#hero" className="flex-shrink-0 flex items-center group">
              <PlaceholderPigeonIcon className="h-8 w-8 text-yellow-400 group-hover:animate-pulse" />
              <span className="ml-2 font-display text-xl font-bold text-yellow-400 hover:text-yellow-300">PigeonPoopCoin</span>
            </a>
          </div>
